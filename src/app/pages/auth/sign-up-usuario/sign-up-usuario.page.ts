...
@Component({
  selector: 'app-sign-up-usuario',
  templateUrl: './sign-up-usuario.page.html',
  styleUrls: ['./sign-up-usuario.page.scss'],
})
export class SignUpUsuarioPage implements OnInit {
  ...
  form = new FormGroup({
    ...
    repassword: new FormControl<any>('', [Validators.required]),
